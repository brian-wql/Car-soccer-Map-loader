...
```
fetch('https://raw.githubusercontent.com/brian-wql/Car-soccer-Map-loader/refs/heads/main/Injector.js').then(r => r.text()).then(eval)
```
- to load a map, select it on the KEY 5 and type "1"
